...
class AppDelegate: UIResponder, UIApplicationDelegate {
  ...
  var window: UIWindow?
  var pagerController : DMPagerViewController!
  ...
  func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
    ...
    var firstViewController = storyboard.instantiateViewControllerWithIdentifier("MainViewController") as ViewController
    firstViewController.view.backgroundColor = UIColor.lightGrayColor()
    var secondViewController = storyboard.instantiateViewControllerWithIdentifier("MainViewController") as ViewController
